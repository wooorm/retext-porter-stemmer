...
suite('retext w/o retext-porter-stemmer', function () {
...
suite('retext w/ retext-porter-stemmer', function () {
    bench('A paragraph (5 sentences, 100 words)', function (done) {
        retextWithPorterStemmer.parse(paragraph, done);
    });

    bench('A section (10 paragraphs, 50 sentences, 1,000 words)',
        function (done) {
            retextWithPorterStemmer.parse(section, done);
        }
    );
});
