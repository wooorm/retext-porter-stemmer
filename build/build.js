...
require.register("wooorm~retext-porter-stemmer@0.2.2", function (exports, module) {
'use strict';
...
stemmer = require('wooorm~stemmer@0.1.3');
...
require.register("retext-porter-stemmer-gh-pages", function (exports, module) {
var porterStemmer = require('wooorm~retext-porter-stemmer@0.2.2'),
    visit = require('wooorm~retext-visit@0.2.2'),
    dom = require('wooorm~retext-dom@0.2.3'),
...
require("retext-porter-stemmer-gh-pages");
